...
def test_search_memories_default_scope_excludes_user_in_public_context(fake_memory_store) -> None:
    memory_tools.configure(
        {
            "memory_store": fake_memory_store,
            "user_id": "slack:U123",
    ...
    _ = asyncio.run(memory_tools.search_memories("deploy status"))
...
def test_list_memories_in_public_context_filters_to_agent_and_global(fake_memory_store) -> None:
